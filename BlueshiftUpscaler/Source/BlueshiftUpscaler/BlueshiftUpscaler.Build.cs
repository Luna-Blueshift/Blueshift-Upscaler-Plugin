...
public static class BlueshiftUpscalerUtils
{
...
public class BlueshiftUpscaler : ModuleRules
{
	public BlueshiftUpscaler(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		// Detect DLSS
		if (BlueshiftUpscalerUtils.DoesPluginExistAndIsEnabled(Target, "DLSS"))
		{
		...
		// Detect FSR
		if (BlueshiftUpscalerUtils.DoesPluginExistAndIsEnabled(Target, "FSR4"))
		{
			PublicDependencyModuleNames.Add("FFXFSR4Settings");
			PublicDefinitions.Add("WITH_FSR4=1");
		}
		else if (BlueshiftUpscalerUtils.DoesPluginExistAndIsEnabled(Target, "FSR3"))
		{
